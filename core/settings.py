...
LOCAL_INDEX_PATH = Path(
    os.getenv("AVANTE_LOCAL_INDEX", "G:/CARTOGRAFIA/FUNDIARIO/RRDOCS/index_arquivos.csv")
)
LOCAL_DOCS_DIR = Path(os.getenv("AVANTE_LOCAL_DOCS_DIR", "G:/CARTOGRAFIA/FUNDIARIO/RRDOCS"))
...
REMOTE_DATA_FOLDER_URL = os.getenv(
    ...
    "https://1drv.ms/f/c/8b88b81c064543d3/IgBGEAmSs4rFSKtxZck7F0iDAbjN8qgzzI2KnfHX6MyE3aU?e=AGKJqk",
).strip()
