...
TOOLTIP_FIELDS = [("Fazenda", "fazenda")]
...
def _build_map_gdf(gdf: gpd.GeoDataFrame, resolved_fields: dict[str, str]) -> gpd.GeoDataFrame:
    ...
    for label, field_key in [*POPUP_FIELDS, *TOOLTIP_FIELDS]:
...
def render_fund_map(
    ...
    tooltip = folium.GeoJsonTooltip(
        fields=[item[0] for item in TOOLTIP_FIELDS],
        aliases=[""],
        labels=False,
        sticky=False,
        style=(
            "background-color: rgba(15, 39, 60, 0.92); "
