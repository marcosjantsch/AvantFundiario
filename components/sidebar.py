...
def render_sidebar(
    ...
    with st.sidebar:
        ...
        show_aux_quilombolas = st.checkbox("Areas de Quilombolas (arquivo local)", value=False)
        show_aux_assentamento_brasil = st.checkbox("Assentamento Brasil (arquivo local)", value=False)
        show_aux_assentamento_reconhecimento = st.checkbox(
            "Assentamento Reconhecimento (arquivo local)", value=False
        )
        show_aux_snci = st.checkbox("Imovel certificado SNCI Brasil (arquivo local)", value=False)
        show_aux_sigefl = st.checkbox("Sigefl (arquivo local)", value=False)
        visualize_layers_clicked = st.button("Visualizar camadas", use_container_width=True)
    ...
    return {
        ...
        "show_car": show_car,
        "show_aux_quilombolas": show_aux_quilombolas,
        "show_aux_assentamento_brasil": show_aux_assentamento_brasil,
        "show_aux_assentamento_reconhecimento": show_aux_assentamento_reconhecimento,
        "show_aux_snci": show_aux_snci,
        "show_aux_sigefl": show_aux_sigefl,
        "visualize_layers_clicked": visualize_layers_clicked,
